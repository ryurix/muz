...
// Filesystem
$moxieManagerConfig['filesystem.rootpath'] = $_SERVER["DOCUMENT_ROOT"]."/files/user";  ///webroot/uploads';
...
$moxieManagerConfig['thumbnail.height'] = 133;
$moxieManagerConfig['thumbnail.folder'] = 'mini';
$moxieManagerConfig['thumbnail.prefix'] = 'mini_';
$moxieManagerConfig['thumbnail.delete'] = true;
$moxieManagerConfig['thumbnail.jpeg_quality'] = 85;
