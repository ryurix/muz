...
const DATA = parent::DATA + [
	...
	352=>['name'=>'Ozon ошибка загрузки цен', 'days'=>31],
	353=>['name'=>'Оzon ошибка выгрузки цен', 'days'=>31],
	354=>['name'=>'Ozon ошибка загрузки наличия', 'days'=>31],
	355=>['name'=>'Ozon ошибка выгрузки наличия', 'days'=>31],

	375=>['name'=>'Ozon API ошибка сбора заказа', 'days'=>31],
	385=>['name'=>'Ozon API ошибка отмены заказа', 'days'=>31],
	399=>['name'=>'Ozon API выгрузка цен', 'days'=>7],
